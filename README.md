...
But Please note the address to cast is not slice's pointer it self but the address of slice's pointer.
See also https://www.techscore.com/tech/Go/Lang/Basic14/ to understand the structure of slices.
...
--------------------------------------------------
                                                                            ...
                                                                            Address to cast for func
                                      prog (type []byte)                   +---------------------+ 0xc000084020
type []byte                           +----------------+ 0xc000078060 <---<| 0xc000078060        | (&ptr) 
+---------------+ 0x7fbadc4bc000 <---<| 0x7fbadc4bc000 | (&prog = ptr)     +---------------------+ 0xc000084028
| prog[0]=0x48  |                     +----------------+                   | inc (func(int) int) |
